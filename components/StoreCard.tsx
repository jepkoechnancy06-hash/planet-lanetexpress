...
const StoreCard: React.FC<StoreCardProps> = ({ store, onSelect }) => {
  return (
    <div className="bg-slate-800 rounded-lg overflow-hidden group border border-slate-700 hover:border-cyan-500 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/10">
